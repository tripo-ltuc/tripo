...
export default function RecipeReviewCard() {
  ...
  return (
    <>
      ...
      <div className="colouredOne">
        {/* <div className="insideColouredOne">
          Reviews and Comments of past visitors!
        </div> */}
        Reviews and Comments of past visitors!
      </div>
      <div className="customizedCards">
        ...
        <div className="cardThree">
          <Card style={{ width: "18rem" }} className={classes.root}>
            ...
            <CardMedia
              className={classes.media}
              image="https://static.euronews.com/articles/stories/05/43/01/18/400x225_cmsv2_e8f55757-04c6-54e9-b3f5-74cfa5bd7b07-5430118.jpg"
              title="Paella dish"
            />
            <CardContent>
              <Typography variant="body2" color="textSecondary" component="p">
