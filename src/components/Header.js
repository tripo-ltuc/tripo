        ...
        <Navbar expand="lg" bg="dark" variant="dark">
          <Container>
            ...
            <Navbar.Collapse className="me-auto justify-content-end text01">
              ...
              <Nav.Link href="/" ><Link to="/">DISCOVER</Link></Nav.Link>
              <Nav.Link href="/reviews" ><Link to="/reviews">REVIEWS</Link></Nav.Link>
              <Nav.Link href="/about-us" ><Link to="/about-us">ABOUT US</Link></Nav.Link>
